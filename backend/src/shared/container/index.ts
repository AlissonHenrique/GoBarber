...
import INotificationsRepositiory from '@modules/notifications/repositories/INotificationsRepository';
...
container.registerSingleton<INotificationsRepositiory>(
